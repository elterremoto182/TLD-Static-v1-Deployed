...
![Moisture detection equipment being used to locate hidden water leaks](/images/gallery/moisture-detection.jpg)

[Professional leak detection](/leak-detection/) can still assess [slab leak](/problems/slab-leak/) or [pipe burst](/problems/pipe-burst/) history and recommend next steps. The technician may use thermal imaging to look for residual moisture or stains, and they can advise whether running water to that line would help locate the source. If you had a leak that stopped, schedule an inspection and ask whether reactivating the line is safe and useful for your situation.
